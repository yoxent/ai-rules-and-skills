...
name:code-maintenance|pri:M|deps:[correctness-validation,clean-code-solid]|flags:[refactoring,technical-debt-management,regression-prevention,architecture-consistency,correctness-validation,test-creation-strategy]|rules:[DA-1,MF-2,MF-1,TQ-3,GM-2]
