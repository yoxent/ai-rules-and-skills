...
Use this only when the user explicitly asks to create/edit a skill. This skill is
script-first: use the Python tooling to scaffold, validate, and package skills.

## Core Intent
- Preserve the original skill-creator workflow based on multiple scripts.
